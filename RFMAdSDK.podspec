Pod::Spec.new do |s|
  ...
  s.platform     = :ios, "7.0"
  s.source       = { :git => "https://github.com/rubicon-project/RFMAdSDK-iOS.git", :tag => "6.1.1" }
  ...
  s.frameworks = "AdSupport" , "AudioToolbox" , "AVFoundation", "CoreGraphics", "CoreMedia", "CoreTelephony", "Foundation", "MediaPlayer", "MessageUI", "SafariServices", "StoreKit", "SystemConfiguration", "UIKit"
  s.library   = "xml2"
  s.requires_arc = true
